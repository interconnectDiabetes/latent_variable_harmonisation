...
######### AS PER FOR CHECKING  - no calibration ######################################
#######################################################################################
...
for (i in 1:numbaselines){
  ...
  for (measurement_error_counter in lowerbound:upperbound) {
    ...
    estimates_cat[measurement_error_counter-lowerbound+1] = estimate_corrected
    std_errors_cat[measurement_error_counter-lowerbound+1] = delta_std_error_corrected
...
#set up plot
svg(filename = paste0('repeat_valid_cat_and_cont_with_RC_outcome_error_',outcome_error,'_', numLevels,'_level_',validation_size,'_valid.svg'), width = 10, height = 15)
old.par <- par(mfrow=c(numbaselines^0.5, numbaselines^0.5))
...
#######################################################################################
####### Bootstrap Continuous and split measurement categorical         ########
#######################################################################################
#
# Code to run continuous and categorical (sub in index mean) measured exposures
# RC is used in both scenarios, with a SE correction using the delta method
...
#######################################################################################
#### BOOTSTRAP  Continuous and REPEAT categorical (index mean subst) with RC #######
#######################################################################################
#
# Code to run continuous and categorical (sub in index mean) measured exposures
# RC is used in both scenarios, with a SE correction using the delta method
...
#set up plot
svg(filename = paste0('boot_repeat_valid_cat_and_cont_with_RC_outcome_error_',outcome_error,'_', numLevels,'_level_',validation_size,'_valid.svg'), width = 10, height = 15)
old.par <- par(mfrow=c(numbaselines^0.5, numbaselines^0.5))
...
#set up plot
svg(filename = paste0('old_repeat_valid_cat_and_cont_with_RC_outcome_error_',outcome_error,'_', numLevels,'_level_',validation_size,'_valid.svg'), width = 10, height = 15)
old.par <- par(mfrow=c(numbaselines^0.5, numbaselines^0.5))
...
#set up plot
svg(filename = paste0('old_not_split_valid_cat_and_cont_with_RC_outcome_error_',outcome_error,'_', numLevels,'_level_',validation_size,'_valid.svg'), width = 10, height = 15)
old.par <- par(mfrow=c(numbaselines^0.5, numbaselines^0.5))
